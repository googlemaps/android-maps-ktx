...
dependencies {
    ...
    implementation 'com.google.maps.android:maps-ktx:<!-- {x-release-please-start-version} -->5.2.1<!-- {x-release-please-end-version} -->'

    // KTX for the Maps SDK for Android Utility Library
    implementation 'com.google.maps.android:maps-utils-ktx:<!-- {x-release-please-start-version} -->5.2.1<!-- {x-release-please-end-version} -->'
}
```
