...
dependencies {
    ...
    implementation 'com.google.maps.android:maps-ktx:6.4.0' // {x-release-please-version}

    // KTX for the Maps SDK for Android Utility Library
    implementation 'com.google.maps.android:maps-utils-ktx:6.4.0' // {x-release-please-version}
}
```
